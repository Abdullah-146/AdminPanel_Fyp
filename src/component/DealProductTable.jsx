...
function DealProductTable(props) {
    ...
    <table style={{ overflowY: "scroll" }}>
      ...
      <tbody>
        ...
        {props.data.map((item, index) => (
          <DiscountProductRow
            selected = {props.selected.map((item)=>item.product).includes(item._id)}
            quantity = {props.selected.find((p)=>p.product.toString() === item._id.toString())?.quantity}
            noId
...
export default DealProductTable;
